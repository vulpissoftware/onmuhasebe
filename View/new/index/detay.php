...
<style>
    ...
    [data-title]:hover::after {
        ...
        border-bottom: 8px solid #124052;
    }
                ...
                <div class="col-md-12">
                    ...
                    <div class="block-product-detail">
                        <div class="row">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <div id="gal1">
                                            <?php foreach ($resim as $image) { ?>
                                                <a href="javascript:;"
                                                   data-image="<?php echo $this->thumbresim($image); ?>"
                            ...
                            <div style=" padding: 0px ! important;" class="col-xs-12 col-sm-12 col-md-6 col-lg-6">

                                <div style=" padding: 0px ! important;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="product-detail-section">
                                        ...
                                        <div class="product-information">
                                            ...
                                            <div class="clearfix">
                                                <label class="pull-left"> Kargo </label>
                                                <p class="description"><?php if ($ilan->korgokime == 1) {
                                                        echo "<i class='fa fa-gift' style='font-size: 20px;color: red;'> </i> Ücretsiz Kargo";
                                                    } else {
                                                        echo "Alıcı Öder";
                                                    } ?></p>
                                            </div>
                                            ...
                                            <div class="clearfix">
                                                <label class="pull-left"> Kargo Süresi</label>
                                                <p class="description"><?php if ($ilan->ks == 1) {
                                                        echo "Mesai saati içinde sipariş verirseniz, Bugün Kargoda";
                                                    } else {
                                                        echo "En geç $ilan->ks gün";
                                                    } ?></p>
                                            </div>
...
border-radius: 5px;
    ...
    padding-left: 0px;">
                                                    ...
                                                    <p class="description">
                                                        <?php $this->help("captcha")->textToImage($api::saticiadi($ilan->user_id)); ?>

                                                        <a href="<?php SELF::go("index/userilan/sirala/" . $ilan->user_id); ?>"
                                                           data-title="Satıcının tüm ürünleri">Tüm Ürünleri&emsp;</a>

                                                        <?php if ($_SESSION["user_id"]): ?>
                                                            <a data-toggle="modal" data-target="#ayhan"
                                                               onclick="yukle('<?php SELF::go("ilan/mesaj/ilanId/" . $ilan->id); ?>','mesajbody')"
                                                               href="#" data-title="İlan sahibine soru sor"
                                                               style="font-size:15px"><i class="fa fa-commenting"
                                                                                         aria-hidden="true"> </i> Soru
                                                                sor</a>
                                                        <?php else: ?>

                                                            <a href="#" id="ismsj" data-toggle="modal"
                                                               data-target="#ayhan" data-title="İlan sahibine soru sor"><i
                                                                        class="fa fa-commenting" aria-hidden="true"
                                                                        style="font-size:15px"> </i> Soru sor</a>
...
border-radius: 5px;
    ...
    padding-left: 5px;">
                                            ...
                                            <script>
                                                $(function () {
                                                    $(".vb li").click(function () {
                                                        $(".vb li").css("background-color", "");
                                                    ...
                                                    <?php else:
                                                        ...
                                                        <div class="clearfix">
                                                            <p class="description">       <?php
                                                                $s1 = explode(",", $secenekx->secenek)[0];
                                                                $s2 = explode(",", $secenekx->secenek)[1];
                                                                echo $cls->modul_items_sa($s1) . " / " . $cls->modul_items_sa($s2);
                                                                $dgr = $cls->uruneaitsecenekler($ilan->id);
                                                                ?>
                                                            </p>
                                                            ...
                                                            <div class="ozlk">
                                                                <ul class="vb">
                                                                    <?php foreach ($dgr as $rt): ?>
                                                                        <li onclick="xxx(<?php echo $rt->id; ?>);"
                                                                            style=" cursor: pointer"><?php echo $cls->seceneksatis(explode(",", $rt->deger)[0]); ?>
                                                                            / <?php echo $cls->seceneksatis(explode(",", $rt->deger)[1]); ?> </li>
                                                                    <?php endforeach; ?>
                                                                </ul>
                                                            </div>
                                ...
                                <div class="urunozellik col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="box-border block-form">
                            ...
                            <div class="tab-content">
                                <div style="overflow: overlay;" class="tab-pane active" id="description">
                                    ...
                                    <?php echo str_replace('""', '"', html_entity_decode($cls->ilanaciklama($ilan->id), ENT_NOQUOTES, 'UTF-8')); ?>
                                </div>
...
<div class="g-recaptcha" data-sitekey="<b>Notice</b>: Undefined variable: site_key in <b>/home/wwwesecuritybaza/public_html/catalog/view/theme/so-shoppystore/template/product/product.tpl</b> on line <b>930</b>"></div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body mesajbody">
                                    ...
                                    <p><a href="<?php SELF::go('user/kayit'); ?>">Mesaj yazabilmek için üye
                                            olmalısınız..</a></p>
                    ...
                    <div class="col-md-12">
                        ...
                        <?php foreach ($api::ktgfirsatnewadet($ilan->id, $k->id, 3) as $tekfirsat) {
                            if ($tekfirsat) { ?>
                                <div class="col-md-4">
                                        ...
                                        <figure class="figure-hover-overlay">
                                            ...
                                            <?php if ($tekfirsat->firsat == 1 && $tekfirsat->fft >= $trh): ?>
                                                <div class="product-sale">
                                                    <?php echo $this->indirim($tekfirsat->ff, $tekfirsat->fiyat); ?>%
                                                    <br>
                                                </div>
                                            <?php endif; ?>
...
<script>
    ...
    function xxx(id) {
        ...
        for (i = 1; i <= sss[id].stok; i++) {
            if (i == 1) {
                $("#quantitySelect").append("<option selected>" + i + "</option>");
            } else {
