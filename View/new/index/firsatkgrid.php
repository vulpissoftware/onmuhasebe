            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="block-breadcrumb">
                        <ul class="breadcrumb">
                            <li>
                                <a href="<?php SELF::go(""); ?>"
                                   class="breadcrump-link"><?php echo "ANA SAYFA"; // echo $lang->anasayfa; ?></a>
                            </li>
                            ...
                            foreach (array_reverse($y['kategori_adi']) as $k) {
                                ...
                                <li>
                                    <a href="<?php self::go('firsat/kategoriler/id/' . $ktgr_id[$x] . '/name/' . $seo->seo($k)); ?>"
                    ...
                    <div class="header-for-left">
                        <h3 class="wow fadeInRight animated" data-wow-duration="1s"><span
                                    style="color: #000"><?php echo $lang->firsat; ?> / <?php echo $k; ?></span></h3>
                ...
                <aside class="col-md-3">
                    ...
                    <div class="widget-block">
                        <ul class="list-unstyled ul-side-category sub-category">
                            ...
                            foreach (array_reverse($y['kategori_adi']) as $k) {
                                ...
                                ?>
                                <li class="lova"><a
                                            href="<?php self::go('firsat/kategoriler/id/' . $ktgr_id[$x] . '/name/' . str_replace(" ", "-", $k)); ?>"><?php echo $k; ?></a>
                                </li>
                            ...
                            <ul id="ayh_arbt" class="">
                                ...
                                foreach ($cls->altkategori($id) as $altktgr) {
                                    ...
                                    <li>
                                        <a href="<?php self::go('firsat/kategoriler/id/' . $altktgr->id . '/name/' . str_replace(" ", "-", $altktgr->kategori_adi)); ?>">

                                            <?php echo $altktgr->kategori_adi; ?>
                                        </a>
                                    </li>
...
<script type="text/javascript">
    ...
    function filtre() {
        ...
        $.post("<?php echo SITE; ?>/firsat_ajax_g/ilanlar",
            {
                il: il,
