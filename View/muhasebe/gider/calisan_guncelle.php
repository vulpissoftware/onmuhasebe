                ...
                <div class="portlet-title">
                    <div class="caption">
                        <div class="caption">
                            ...
                            / <span class="caption-helper">ÇALIŞAN GÜNCELLE</span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="portlet light bg-inverse form-fit">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="<?php SELF::go("calisan/calisan_guncelle"); ?>" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="ADI SOYADI *" name="isim"
                                                       class="form-control" value="<?php echo $musteri->adi; ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" placeholder="E-POSTA ADRESİ" name="mail"
                                                       class="form-control input-medium" value="<?php echo $musteri->mail; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="TC KİMLİK NO" name="tc"
                                                       class="form-control input-medium" value="<?php echo $musteri->tc; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="IBAN NUMARASI" name="iban"
                                                       class="form-control input-medium" value="<?php echo $musteri->iban; ?>">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control input-medium" id="frmktgr"
                                                    ...
                                                    <?php foreach ($cls->calisankategori() as $value) { ?>
                                                        <option value="<?php echo $value->id; ?>" <?php if ($value->id == $musteri->kategori) {
                                                            echo "selected";
