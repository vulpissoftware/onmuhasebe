            ...
            <div class="page-head">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-haze bold uppercase">Hizvet Ürün Kopya</span>
                    ...
                    <div class="row">
                        ...
                        <div class="portlet light bg-inverse form-fit">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="<?php SELF::go("stok_kayit/hizmet_urun_k"); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder=""
                                                       value="<?php echo $urun->barkot_kodu; ?>" name="bk" id="bkdno"
                                                       class="form-control">
                                            ...
                                            <div class="col-md-9">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput"
                                                        ...
                                                        <input type='hidden' name='resim_'
                                                               value='<?PHP echo $urun->urun_resmi; ?>'/>
                                            ...
                                            <script>
                                                $(document).ready(function () {
                                                    $('form').submit(function () {
                                                        var bn = $("#bkdno").val();
                                                        var sabitbn = '<?php echo $urun->barkot_kodu; ?>';
                                                        if (bn == sabitbn) {
                                                            alert("Barkod Numaraları aynı olmamalıdır.");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group input-large" style="float: right">
                                                    ...
                                                    <button type="submit" class="btn green" target=""> Kopya Oluştur.
                                                    </button>
