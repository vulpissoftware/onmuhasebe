            ...
            <div class="page-head">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span>Fiyat Listesi Güncelleme Ekranı
                                                    </span>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="portlet light bg-inverse form-fit">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="<?php SELF::go("stok_kayit/fiyat_listesi_g"); ?>"
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="" value="<?php echo $fl->ad; ?>"
                                                       name="ad" class="form-control">
