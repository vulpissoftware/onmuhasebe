                ...
                <div class="portlet-title">
                    <div class="caption">
                        <div class="caption">
                            ...
                            / <span class="caption-helper">MÜŞTERİ GÜNCELLE</span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="portlet light bg-inverse form-fit">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="<?php SELF::go("musteri/musteri_guncelle"); ?>" method="post"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="VKN / TCKN"  value="<?php echo $musteri->vkn_tckn; ?>"
