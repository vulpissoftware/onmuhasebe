...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
            ...
            <div class="page-head">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-haze bold uppercase">SATIŞLAR</span> / <span
                                class="caption-helper">MÜŞTERİ LİSTESİ</span>
                    </div>
                    <?php if ($mesaj): ?>
        ...
        <script>
            ...
            function ekle() {
                location.replace('<?php SELF::go('musteri/musteri'); ?>');
            }
