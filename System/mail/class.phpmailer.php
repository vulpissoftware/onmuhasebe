...
class PHPMailer
{
    ...
    function SetLanguage($langcode = 'en', $lang_path = 'language/')
    {
        ...
        $PHPMAILER_LANG = array(
            ...
            'empty_message' => 'Mesaj içeriği boş',
            'encoding' => 'Bilinmeyen şifreleme: ',
            'execute' => 'Çalıtırılamıyor: ',
            'file_access' => 'Dosyaya erişilemiyor: ',
            'file_open' => 'Dosya Hatası: Dosya açılamıyor: ',
            'from_failed' => 'Başarısız olan gönderici adresi: ',
            'instantiate' => 'Örnek mail fonksiyonu oluşturulamadı.',
            'invalid_address' => 'Gönderilmedi, email adresi geçersiz: ',
            ...
            'recipients_failed' => 'SMTP Hatası: alıcılara ulaımadı: ',
            'signing' => 'İmzalama hatası: ',
            'smtp_connect_failed' => 'SMTP Connect() hatası.',
            'smtp_error' => 'SMTP sunucu hatası: ',
            'variable_set' => 'Ayarlanamıyor yada sıfırlanamıyor: '
        );
